...
class PostView extends Component {
    ...
    render() {
        const { text, claps, title, feature_img, author } = this.props._post
                        ...
                        <div className="post-stats clearfix">
                            <div className="pull-left">
                                <div className="like-button-wrapper">
                                    <button onClick={() => this.props.clap(this.props._post._id)} className="like-button" data-behavior="trigger-overlay" type="submit">
...
/*function mapStateToProps (state, ownProps) {
    ...
    let post = {}
    state.posts.posts.forEach((_post)=>{
        if(post_id == _post._id) {
            post = _post
        }
    })
    return { post }
